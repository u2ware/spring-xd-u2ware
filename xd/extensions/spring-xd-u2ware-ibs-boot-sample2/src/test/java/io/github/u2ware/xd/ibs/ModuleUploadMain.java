...
public class ModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(ModuleUploadMain.class);

    private static final String moduleName     = "u2ware-ibs-boot-sample2";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-ibs-boot-sample2-1.0.0.jar";
