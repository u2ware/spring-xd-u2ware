...
public class HelloworldUiModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(HelloworldUiModuleUploadMain.class);

    private static final String moduleName     = "u2ware-ibs-boot-helloworld-ui";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-ibs-boot-helloworld-ui-1.0.0.jar";
