...
public class ModuleUploadMain {
    ...
    private static final String moduleName     = "u2ware-ibs-boot-sample1";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-ibs-boot-sample1-1.0.0.jar";
