...
public class ResourceServerModuleUploadMain {
    ...
    private static final String moduleName     = "u2ware-web-resource-server";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-web-resource-server-1.0.0.jar";
