...
public class RestMongodbServerModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(RestMongodbServerModuleUploadMain.class);

    private static final String moduleName     = "u2ware-web-rest-mongodb-server";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-web-rest-mongodb-server-1.0.0.jar";
