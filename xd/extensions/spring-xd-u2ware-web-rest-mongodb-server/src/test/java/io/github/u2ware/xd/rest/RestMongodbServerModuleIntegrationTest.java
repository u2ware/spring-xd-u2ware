...
public class RestMongodbServerModuleIntegrationTest {
	...
	public static void beforeClass() throws Exception{
		...
		singleNodeIntegrationTestSupport.addModuleRegistry(
				new SingletonModuleRegistry(ModuleType.source, "web-rest-mongodb-server"));
	}
	...
	public void test() throws InterruptedException {
		...
		String processingChainUnderTest = "web-rest-mongodb-server "
				+ " --httpPort=9998 "
				+ " --httpTimeout=1000 "
				+ " --host=127.0.0.1 "
				+ " --port=27017 ";
