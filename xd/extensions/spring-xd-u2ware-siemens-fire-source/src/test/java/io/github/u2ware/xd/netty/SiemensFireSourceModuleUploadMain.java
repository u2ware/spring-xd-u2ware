...
public class SiemensFireSourceModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(SiemensFireSourceModuleUploadMain.class);

    private static final String moduleName     = "u2ware-siemens-fire-source";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-siemens-fire-source-1.0.0.jar";
