...
public class MongodbRestApplicationRunner implements InitializingBean, DisposableBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		if(defaultProperties != null){
			for(String key : defaultProperties.keySet()){
				System.setProperty("MongodbRestApplicationRunner."+key, defaultProperties.get(key).toString());
			}
		}
