...
public class SnmpProcessorModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(SnmpProcessorModuleUploadMain.class);

    private static final String moduleName     = "u2ware-snmp-processor";
    private static final String moduleType     = "processor";
    private static final String moduleResource = "target/spring-xd-u2ware-snmp-processor-1.0.0.jar";
    ...
    public static void main(String[] args) throws Exception{
		...
		logger.info("ModuleUploadPlugin sourceUri: "+targetResource);
