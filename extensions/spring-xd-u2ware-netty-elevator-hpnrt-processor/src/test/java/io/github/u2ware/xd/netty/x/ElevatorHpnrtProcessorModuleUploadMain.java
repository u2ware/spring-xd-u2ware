...
public class ElevatorHpnrtProcessorModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(ElevatorHpnrtProcessorModuleUploadMain.class);

    private static final String moduleName     = "u2ware-netty-elevator-hpnrt-processor";
    private static final String moduleType     = "processor";
    private static final String moduleResource = "target/spring-xd-u2ware-netty-elevator-hpnrt-processor-1.0.0.jar";
