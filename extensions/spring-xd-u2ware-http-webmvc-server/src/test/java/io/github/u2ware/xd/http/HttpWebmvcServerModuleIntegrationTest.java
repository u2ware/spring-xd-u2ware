...
public class HttpWebmvcServerModuleIntegrationTest {
	...
	public static void beforeClass() throws Exception{
		...
		singleNodeIntegrationTestSupport.addModuleRegistry(
				new SingletonModuleRegistry(ModuleType.source, "http-webmvc-server"));
	}
	...
	public void test() throws InterruptedException {
		...
		String result = restTemplate.getForObject("http://localhost:9993/hello/foo",  String.class);
		logger.debug(result);
