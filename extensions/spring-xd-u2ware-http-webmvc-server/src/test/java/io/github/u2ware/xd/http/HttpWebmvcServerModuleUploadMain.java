...
public class HttpWebmvcServerModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(HttpWebmvcServerModuleUploadMain.class);

    private static final String moduleName     = "u2ware-http-webmvc-server";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-http-webmvc-server-1.0.0.jar";
