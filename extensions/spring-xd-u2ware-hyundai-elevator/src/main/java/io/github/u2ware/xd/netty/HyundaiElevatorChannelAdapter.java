...
public class HyundaiElevatorChannelAdapter extends NettyTcpClient{
	...
	protected void initChannelPipeline(ChannelPipeline pipeline) throws Exception {
		...
		pipeline.addLast("messageHandle", new NettyMessageHandler(sendChannel, receiveChannel, 1000));
	}
