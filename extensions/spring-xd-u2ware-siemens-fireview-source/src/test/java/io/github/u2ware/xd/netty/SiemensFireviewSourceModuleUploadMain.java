...
public class SiemensFireviewSourceModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(SiemensFireviewSourceModuleUploadMain.class);

    private static final String moduleName     = "u2ware-siemens-fireview-source";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-siemens-fireview-source-1.0.0.jar";
