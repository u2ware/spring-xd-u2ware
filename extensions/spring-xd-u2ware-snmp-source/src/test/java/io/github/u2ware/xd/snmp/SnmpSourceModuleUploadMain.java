...
public class SnmpSourceModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(SnmpSourceModuleUploadMain.class);

    private static final String moduleName     = "u2ware-snmp-source";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-snmp-source-1.0.0.jar";
