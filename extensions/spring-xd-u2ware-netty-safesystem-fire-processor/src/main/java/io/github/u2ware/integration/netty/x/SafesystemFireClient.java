...
public class SafesystemFireClient extends AbstractTcpClient{
	...
	protected void initChannelPipeline(ChannelPipeline pipeline) throws Exception {
		...
		//pipeline.addLast(new DelimiterBasedFrameDecoder(2048, false, SafesystemFireClientHandler.ETX));
		pipeline.addLast(new SafesystemFireClientHandler(getClass()));
