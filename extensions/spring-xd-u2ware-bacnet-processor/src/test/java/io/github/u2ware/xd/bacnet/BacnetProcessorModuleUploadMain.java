...
public class BacnetProcessorModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(BacnetProcessorModuleUploadMain.class);

    private static final String moduleName     = "u2ware-bacnet-processor";
