...
public class MongodbSinkModuleUploadMain {
    ...
    private static final String moduleName     = "u2ware-data-mongodb-sink";
    private static final String moduleType     = "sink";
    private static final String moduleResource = "target/spring-xd-u2ware-data-mongodb-sink-1.0.0.jar";
