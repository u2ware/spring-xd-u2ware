...
public class ModbusProcessorModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(ModbusProcessorModuleUploadMain.class);

    private static final String moduleName     = "u2ware-modbus-processor";
    private static final String moduleType     = "processor";
    private static final String moduleResource = "target/spring-xd-u2ware-modbus-processor-1.0.0.jar";
