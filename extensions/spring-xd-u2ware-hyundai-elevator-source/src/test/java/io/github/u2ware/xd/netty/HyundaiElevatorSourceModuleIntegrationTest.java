...
public class HyundaiElevatorSourceModuleIntegrationTest {
	...
	public static void beforeClass() throws Exception{
		...
		singleNodeIntegrationTestSupport.addModuleRegistry(
				new SingletonModuleRegistry(ModuleType.source, "hyundai-elevator-source"));
	}
	...
	public void test() throws InterruptedException {
		...
		String processingChainUnderTest = "hyundai-elevator-source "
				+ " --host=127.0.0.1 "
				+ " --port=9992 "
				+ " --idleTimeout=5000"
				+ " --jsonOutput=false ";
		...
		Assert.assertEquals(HyundaiElevatorResponse.class, payload.getClass());
