...
public class HyundaiElevatorSourceModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(HyundaiElevatorSourceModuleUploadMain.class);

    private static final String moduleName     = "u2ware-hyundai-elevator-source";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-hyundai-elevator-source-1.0.0.jar";
