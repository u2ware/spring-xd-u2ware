...
public class HyundaiElevatorRestSourceModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(HyundaiElevatorRestSourceModuleUploadMain.class);

    private static final String moduleName     = "u2ware-hyundai-elevator-rest-source";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-hyundai-elevator-rest-source-1.0.0.jar";
