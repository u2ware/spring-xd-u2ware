...
public class ModbusRestSourceModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(ModbusRestSourceModuleUploadMain.class);

    private static final String moduleName     = "u2ware-modbus-rest-source";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-modbus-rest-source-1.0.0.jar";
