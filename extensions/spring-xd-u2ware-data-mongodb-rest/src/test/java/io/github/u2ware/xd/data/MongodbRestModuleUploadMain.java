...
public class MongodbRestModuleUploadMain {
    ...
    private static final String moduleName     = "u2ware-data-mongodb-rest";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-data-mongodb-rest-1.0.0.jar";
