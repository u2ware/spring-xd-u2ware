...
public class MongoDbRestSourceModuleUploadMain {
	
    protected static Log logger = LogFactory.getLog(MongoDbRestSourceModuleUploadMain.class);

    private static final String moduleName     = "u2ware-mongodb-rest-source";
    private static final String moduleType     = "source";
    private static final String moduleResource = "target/spring-xd-u2ware-mongodb-rest-source-1.0.0.jar";
